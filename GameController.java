...
public class GameController implements ActionListener {
    ...
    LinkedStack modelStack = new LinkedStack();
    LinkedStack dotStack = new LinkedStack();
    LinkedStack remodelStack = new LinkedStack();
    LinkedStack redotStack = new LinkedStack();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() instanceof DotButton) {
         ...
         if (gameModel.getCurrentStatus(clicked.getColumn(),clicked.getRow()) ==
          ...
          while(!remodelStack.isEmpty()&&!redotStack.isEmpty()){
           remodelStack.pop();
           redotStack.pop();
          }
          
          try {
           modelStack.push(gameModel.cloneModel());
          } catch (CloneNotSupportedException e1) {
           e1.printStackTrace();
          }
             
             Point p=gameModel.getCurrentDot();
             try {
           dotStack.push(p.clone());
          } catch (CloneNotSupportedException e1) {
           e1.printStackTrace();
          }
           ...
           redotStack.pop();
                ...
                while(!modelStack.isEmpty()&&!dotStack.isEmpty()){
           modelStack.pop();
           dotStack.pop();
          }
            } else if (clicked.getText().equals("Undo")&&!modelStack.isEmpty()&&!dotStack.isEmpty()){
             
             try {
           remodelStack.push(gameModel.cloneModel());
          } catch (CloneNotSupportedException e1) {
           e1.printStackTrace();
          }
             ...
             Point p=gameModel.getCurrentDot();
             try {
           redotStack.push(p.clone());
          } catch (CloneNotSupportedException e1) {
           e1.printStackTrace();
          }

             gameModel.setModel((int[][])modelStack.pop());
       
       Point tmpDot=(Point)dotStack.pop();
       gameModel.setCurrentDot(tmpDot.getX(), tmpDot.getY());
       gameView.update();
       

            } else if (clicked.getText().equals("Redo")&&!remodelStack.isEmpty()&&!redotStack.isEmpty()){
             try {
           modelStack.push(gameModel.cloneModel());
          } catch (CloneNotSupportedException e1) {
           e1.printStackTrace();
           ...
           e1.printStackTrace();
             ...
             gameModel.setModel((int[][])remodelStack.pop());
             Point tmpDot=(Point)redotStack.pop();
       gameModel.setCurrentDot(tmpDot.getX(), tmpDot.getY());
       gameView.update();
            }
        }
